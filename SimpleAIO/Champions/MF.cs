...
namespace SimpleAIO.Champions
{
    internal class MF
    {
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            {
              if (mainMenu["Draw"].GetValue<MenuBool>("qRange").Enabled) if (Q.IsReady()) CircleRender.Draw(PlayerPos, Q.Range, Color.Cyan);
              if (mainMenu["Draw"].GetValue<MenuBool>("wRange").Enabled) if (W.IsReady()) CircleRender.Draw(PlayerPos, W.Range, Color.Silver);
              if (mainMenu["Draw"].GetValue<MenuBool>("eRange").Enabled) if (E.IsReady()) CircleRender.Draw(PlayerPos, E.Range, Color.Yellow);
              if (mainMenu["Draw"].GetValue<MenuBool>("rRange").Enabled) if (R.IsReady()) CircleRender.Draw(PlayerPos, R.Range, Color.Blue);
